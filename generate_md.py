...
acknowledgement = '诚挚感谢 [MathJax](https://www.mathjax.org/), Mantej 《Math Expressions in Markdown Using MathJax and Jekyll》](https://mantejjosan.github.io/math-made-easy/tut/), 李宇琨《Write LaTeX Equations in Jekyll Using MathJax & Kramdown》](https://lyk6756.github.io/2016/11/25/write_latex_equations.html) 提供数学公式显示方案\n\n'
